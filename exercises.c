...
{
  Vector * vectorAux = (Vector *) malloc(n * sizeof(Vector));
  if(vectorAux == NULL) return NULL;
  vectorAux->datos = (int *) calloc(n, sizeof(int));
  if(vectorAux->datos == NULL) return NULL;
  vectorAux->capacidad = n;
